...
class ThreeSpaceViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.lineScene.setup3dCameraNode()
        ...
        if manager.isAccelerometerAvailable {
            ...
            manager.startDeviceMotionUpdates(to: OperationQueue.current!) { (motion: CMDeviceMotion?, error: Error?) in
                ...
                if let acceleration = motion?.userAcceleration {
                    ...
                    coordZ = coordZ + velocityZ * updateTime + accelerationZ * updateTime * updateTime * 0.5
